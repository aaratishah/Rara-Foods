...
export default function ItemAdd(props) {
  ...
  const fillForm = (data) => {
    ...
    setPhotoImage({
      ...
      citizen: data?.citizen?.document ? [data.citizen.document] : [],
    ...
    formRef.current.setFieldsValue({
      ...
      vehicle: {
        ...
        issuedDate: data?.vehicle?.issuedDate ? moment(data.vehicle.issuedDate) : null,
      },
      blueBook: {
        ...data.blueBook,
        issuedDate: data?.blueBook?.issuedDate ? moment(data.blueBook.issuedDate) : null,
        expireDate: data?.blueBook?.expireDate ? moment(data.blueBook.expireDate) : null,
      },
      insurance: {
        ...data.insurance,
        issuedDate: data?.insurance?.issuedDate ? moment(data.insurance.issuedDate) : null,
        expireDate: data?.insurance?.expireDate ? moment(data.insurance.expireDate) : null,
      },
      citizenship: {
        ...data.citizenship,
        issuedDate: data?.citizenship?.issuedDate ? moment(data.citizenship.issuedDate) : null,
      },
      license: {
        ...data.license,
        issuedDate: data?.license?.issuedDate ? moment(data.license.issuedDate) : null,
        expireDate: data?.license?.expireDate ? moment(data.license.expireDate) : null,
      },
        ...
        >
          ...
          >
            ...
            >
              ...
              <Col>
                <Form.Item>
                  <Button type={'primary'} onClick={onRiderRequestPending}>Move to Pending List</Button>
                </Form.Item>
              </Col>
              }
            </Row>
