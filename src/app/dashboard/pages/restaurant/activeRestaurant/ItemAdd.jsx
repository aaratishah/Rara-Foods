						...
						<div className="desc">
							{restaurantEmail ? (
								<>
									...
									>
										Password:{' '}
										{getPasswordFromEmail(restaurantEmail)}
									</Paragraph>
								</>
							) : (
								<Paragraph>
									Please input restaurant email to get login
									credentials
								</Paragraph>
							)}
						</div>
	...
	return (
		...
		>
			<AddPageLayout
				title={
					itemId
						? `Update ${pageTitle} Vendor`
						: `Add ${pageTitle} Vendor`
				}
				breadCrumb={[
					{
						title: 'Home',
